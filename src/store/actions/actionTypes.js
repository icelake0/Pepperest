...
export const UPDATE_INTENDED_LOCATION = 'UPDATE_INTENDED_LOCATION';
...
export const FINISHED_ADDING_PRODUCT = 'FINISHED_ADDING_PRODUCT';
export const ADDING_PRODUCT_FAILED = 'ADDING_PRODUCT_FAILED';
...
export const ADDING_MEDIA_LINK = "ADDING_MEDIA_LINK";
export const ADDED_MEDIA_LINK  = "ADDED_MEDIA_LINK";
export const FAILED_TO_ADD_MEDIA_LINK  = "FAILED_TO_ADD_MEDIA_LINK";

export const REMOVING_MEDIA_LINK = "REMOVING_MEDIA_LINK";
export const REMOVED_MEDIA_LINK  = "REMOVED_MEDIA_LINK";
export const FAILED_TO_REMOVE_MEDIA_LINK  = "FAILED_TO_REMOVE_MEDIA_LINK";

export const LOADING_MACHANT_STORE = 'LOADING_MACHANT_STORE';
export const FINISHED_LOADING_MACHANT_STORE = 'FINISHED_LOADING_MACHANT_STORE';
export const LOADING_MACHANT_STORE_FAILED = 'LOADING_MACHANT_STORE_FAILED';
...
export const FAILED_TO_ADD_ITEM_TO_CART = "FAILED_TO_ADD_ITEM_TO_CART";

export const REMOVING_ITEM_FROM_CART = "REMOVING_ITEM_FROM_CART";
export const REMOVED_ITEM_FROM_CART = "REMOVED_ITEM_FROM_CART";
export const FAILED_TO_REMOVE_ITEM_FROM_CART = "FAILED_TO_REMOVE_ITEM_FROM_CART";
