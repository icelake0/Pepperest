      ...
      <div className="list-modal__body">
        <div className="list-modal__header">
          <PepperestContext.Consumer>
            {
              (context) => (
                <div className="list-item-detail__container-close" onClick={() => { context.updateShowPaymentListModal(false); }}>Close</div>
              )
            }
          </PepperestContext.Consumer>
        </div>
        <ul className="list-modal__list">
          ...
          <li className="list-modal__list-item">
            ...
            <p className="list-item-detail__main-item__details">
              ...
              posuere erat. Integer posuere odio tincidunt velit ornare, feugiat
              venenatis
            </p>
          </li>
